webpackJsonp([1],Array(59).concat([
/* 59 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_header__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_backtop__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_backtop___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_backtop__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_loading__ = __webpack_require__(123);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__store_topicTab__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__utils_timeAgo__ = __webpack_require__(117);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    beforeRouteLeave(to, from, next) {
        if (to.name === 'topic') {
            ...
            sessionStorage.setItem('searchOption', __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify___default()(this.searchOption));
    ...
    methods: {
        getTopics() {
            this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_6__store_mutationTypes__["a" /* GET_TOPIC_LIST */], this.searchOption);
        },
        getTabInfo(item) {
            let tab = item.tab;
            if (item.good) {
            ...
            return __WEBPACK_IMPORTED_MODULE_7__store_topicTab__["a" /* topicTab */][tab];
        },
        getScrollData() {
            const y = document.body.scrollTop || document.documentElement.scrollTop;
            ...
            if (dom.length && dom[dom.length - 1].offsetTop + dom[dom.length - 1].offsetHeight <= y + documentH && !this.scrollDelay) {
                ...
                this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_6__store_mutationTypes__["b" /* UPDATE_TOPIC_LIST */], this.searchOption).then(() => {
    ...
    computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vuex__["b" /* mapState */])(['topics', 'showLoad', 'showListLoad']), {
        pageTitle() {
    ...
    components: {
        nvHead: __WEBPACK_IMPORTED_MODULE_3__components_header___default.a,
        nvTop: __WEBPACK_IMPORTED_MODULE_4__components_backtop___default.a,
        nvLoad: __WEBPACK_IMPORTED_MODULE_5__components_loading___default.a
    }
});
...
// module
exports.push([module.i, ".loading{width:1.2rem;margin:.05px auto;text-align:center}.loading .icon-loading{color:#ccc;display:inline-block;font-size:.5rem;-webkit-animation:gif 1s infinite linear;animation:gif 1s infinite linear}@keyframes gif{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}@-webkit-keyframes gif{0%{-webkit-transform:rotate(0deg)}to{-webkit-transform:rotate(1turn)}}.topic{padding-top:.4rem}.topic .topic-list li{border-bottom:1px solid #f0f0f0}.topic .topic-list li:hover{background-color:#f5f5f5}.topic .topic-list li a{padding:.1rem .15rem;display:block}.topic .topic-list li a .top{padding:.05rem 0;display:flex}.topic .topic-list li a .top span.normal{flex:0 0 auto;background-color:#e5e5e5;padding:2px 4px;border-radius:3px;color:#999;font-size:.12rem}.topic .topic-list li a .top span.normal.color{background-color:#80bd01;color:#fff}.topic .topic-list li a .top h3{color:#000;flex:1 1 auto;margin-left:.05rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:.16rem}.topic .topic-list li a .bottom{display:flex;align-items:center}.topic .topic-list li a .bottom .author{flex:0 0 auto;width:.38rem;height:.38rem;margin-right:.15rem;border:1px solid #ddd;border-radius:50%;background-size:cover}.topic .topic-list li a .bottom .info{flex:1 1 auto}.topic .topic-list li a .bottom .info p{display:flex;font-size:.12rem;color:#778087}.topic .topic-list li a .bottom .info p span:first-child{flex:1 1 auto}.topic .topic-list li a .bottom .info p span:last-child{flex:0 0 auto}.topic .topic-title{padding:.05prem;margin:.15rem;font-size:.18rem;color:#2c3e50;line-height:1.5;background-color:#f0f0f0;border-radius:.05rem}.topic .author-info{display:-webkit-flex;display:flex;align-items:center;font-size:.12rem;color:#34495e;padding:0 .15rem}.topic .author-info img.avatar{width:.4rem;height:.4rem;border-radius:50%;margin-right:.15rem}.topic .author-info .center{flex:1}.topic .author-info .center .author,.topic .author-info .center .info{display:block;padding:.05rem 0}.topic .author-info .right .tag{color:#999;padding:.05rem .06rem;font-size:.12rem;border-radius:.04rem;text-align:center;display:block;background-color:#e5e5e5}.topic .author-info .right .tag.color{background-color:#80bd01;color:#fff}.topic .author-info .right .name{padding:.05rem 0;display:block}.topic .topic-content{margin-top:.15rem}.topic .topic-content,.topic .topic-reply .topic-total{padding:.15rem;border-bottom:1px solid #d4d4d4}.topic .topic-reply .topic-total strong{color:#42b983}.topic .topic-reply .reply-list{margin-top:.15rem}.topic .topic-reply .reply-list li{padding:.15rem;border-bottom:1px solid #d4d4d4}.topic .topic-reply .reply-list li .user{display:-webkit-flex;display:flex}.topic .topic-reply .reply-list li .user .head{width:.45rem;height:.45rem;margin-right:.1rem;display:inline-block}.topic .topic-reply .reply-list li .user .info{flex:1;display:-webkit-flex;display:flex;align-items:center}.topic .topic-reply .reply-list li .user .info .left{flex:1;color:#626262}.topic .topic-reply .reply-list li .user .info .right{display:flex;align-items:center}.topic .topic-reply .reply-list li .user .info .right .iconfont{font-size:.26rem}.topic .topic-reply .reply-list li .user .info .right .iconfont.icon-dianzan.uped{color:#80bd01}.topic .topic-reply .reply-list li .reply-content{margin-top:.15rem}.topic .topic-reply .reply-list li .reply-content img{max-width:100%;border:0;vertical-align:middle}.topic .topic-reply .reply-list li:last-child{border-bottom:none}.topic .reply{margin:0 .15rem}.topic .reply textarea{width:100%;background-color:#fff;font-size:.14rem;padding:.15rem;color:#313131;border:1px solid #d5dbdb}.topic .reply .btn-reply{border-bottom:2px solid #3aa373;background-color:#4fc08d;font-size:.16rem;margin:.15rem 0;color:#fff;padding:.1rem;width:100%;border-radius:.03rem}", "", {"version":3,"sources":["D:/WorkSpace/vue2-cnode/src/pages/topicList.vue"],"names":[],"mappings":"AACA,SACE,aAAc,AAEd,kBAAoB,AACpB,iBAAmB,CACpB,AACD,uBACI,WAAY,AACZ,qBAAsB,AACtB,gBAAiB,AACjB,yCAA0C,AAC1C,gCAAkC,CACrC,AACD,eACA,GACI,+BAAgC,AAChC,sBAAwB,CAC3B,AACD,GACI,gCAAkC,AAClC,uBAA0B,CAC7B,CACA,AACD,uBACA,GACI,8BAAgC,CACnC,AACD,GACI,+BAAkC,CACrC,CACA,AACD,OACE,iBAAmB,CACpB,AACD,sBACI,+BAAiC,CACpC,AACD,4BACM,wBAA0B,CAC/B,AACD,wBACM,qBAAuB,AACvB,aAAe,CACpB,AACD,6BACQ,iBAAkB,AAClB,YAAc,CACrB,AACD,yCACU,cAAe,AACf,yBAA0B,AAC1B,gBAAiB,AACjB,kBAAmB,AACnB,WAAY,AACZ,gBAAkB,C
":"topicList.vue","sourcesContent":["\n.loading {\n  width: 1.2rem;\n  /*height: 120px;*/\n  margin: 0.05px auto;\n  text-align: center;\n}\n.loading .icon-loading {\n    color: #ccc;\n    display: inline-block;\n    font-size: .5rem;\n    -webkit-animation: gif 1s infinite linear;\n    animation: gif 1s infinite linear;\n}\n@keyframes gif {\n0% {\n    -webkit-transform: rotate(0deg);\n    transform: rotate(0deg);\n}\n100% {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg);\n}\n}\n@-webkit-keyframes gif {\n0% {\n    -webkit-transform: rotate(0deg);\n}\n100% {\n    -webkit-transform: rotate(360deg);\n}\n}\n.topic {\n  padding-top: .4rem;\n}\n.topic .topic-list li {\n    border-bottom: 1px solid #f0f0f0;\n}\n.topic .topic-list li:hover {\n      background-color: #f5f5f5;\n}\n.topic .topic-list li a {\n      padding: .10rem .15rem;\n      display: block;\n}\n.topic .topic-list li a .top {\n        padding: .05rem 0;\n        display: flex;\n}\n.topic .topic-list li a .top span.normal {\n          flex: 0 0 auto;\n          background-color: #e5e5e5;\n          padding: 2px 4px;\n          border-radius: 3px;\n          color: #999;\n          font-size: .12rem;\n}\n.topic .topic-list li a .top span.normal.color {\n            background-color: #80bd01;\n            color: #fff;\n}\n.topic .topic-list li a .top h3 {\n          color: #000;\n          flex: 1 1 auto;\n          margin-left: .05rem;\n          overflow: hidden;\n          text-overflow: ellipsis;\n          white-space: nowrap;\n          font-size: .16rem;\n}\n.topic .topic-list li a .bottom {\n        display: flex;\n        align-items: center;\n}\n.topic .topic-list li a .bottom .author {\n          flex: 0 0 auto;\n          width: .38rem;\n          height: .38rem;\n          margin-right: .15rem;\n          border: 1px solid #ddd;\n          border-radius: 50%;\n          background-size: cover;\n}\n.topic .topic-list li a .bottom .info {\n          flex: 1 1 auto;\n}\n.topic .topic-list li a .bottom .info p {\n            display: flex;\n            font-size: .12rem;\n            color: #778087;\n}\n.topic .topic-list li a .bottom .info p span:first-child {\n              flex: 1 1 auto;\n}\n.topic .topic-list li a .bottom .info p span:last-child {\n              flex: 0 0 auto;\n}\n.topic .topic-title {\n    padding: .05prem;\n    margin: .15rem;\n    font-size: .18rem;\n    color: #2c3e50;\n    line-height: 1.5;\n    background-color: #f0f0f0;\n    border-radius: 0.05rem;\n}\n.topic .author-info {\n    display: -webkit-flex;\n    display: flex;\n    align-items: center;\n    font-size: .12rem;\n    color: #34495e;\n    padding: 0 .15rem;\n}\n.topic .author-info img.avatar {\n      width: .4rem;\n      height: .4rem;\n      border-radius: 50%;\n      margin-right: .15rem;\n}\n.topic .author-info .center {\n      flex: 1;\n}\n.topic .author-info .center .author,\n      .topic .author-info .center .info {\n        display: block;\n        padding: .05rem 0;\n}\n.topic .author-info .right .tag {\n      color: #999;\n      padding: 0.05rem 0.06rem;\n      font-size: .12rem;\n      border-radius: 0.04rem;\n      text-align: center;\n      display: block;\n      background-color: #e5e5e5;\n}\n.topic .author-info .right .tag.color {\n        background-color: #80bd01;\n        color: #fff;\n}\n.topic .author-info .right .name {\n      padding: .05rem 0;\n      display: block;\n}\n.topic .topic-content {\n    padding: .15rem;\n    margin-top: .15rem;\n    border-bottom: 1px solid #d4d4d4;\n}\n.topic .topic-reply .topic-total {\n    padding: .15rem;\n    border-bottom: 1px solid #d4d4d4;\n}\n.topic .topic-reply .topic-total strong {\n      color: #42b983;\n}\n.topic .topic-reply .reply-list {\n    margin-top: .15rem;\n}\n.topic .topic-reply .reply-list li {\n      padding: .15rem;\n      border-bottom: 1px solid #d4d4d4;\n}\n.topic .topic-reply .reply-list li .user {\n        display: -webkit-flex;\n        display: flex;\n}\n.topic .topic-reply .reply-list li .user .head {\n          width: .45rem;\n          height: .45rem;\n          margin-right: .1rem;\n          display: inline-block;\n}\n.topic .topic-reply .reply-list li .user .info {\n          flex: 1;\n          display: -webkit-flex;\n          display: flex;\n          align-items: center;\n}\n.topic .topic-reply .reply-list li .user .info .left {\n            flex: 1;\n            color: #626262;\n}\n.topic .topic-reply .reply-list li .user .info .right {\n            display: flex;\n            align-items: center;\n}\n.topic .topic-reply .reply-list li .user .info .right .iconfont {\n              font-size: 0.26rem;\n}\n.topic .topic-reply .reply-list li .user .info .right .iconfont.icon-dianzan.uped {\n                color: #80bd01;\n}\n.topic .topic-reply .reply-list li .reply-content {\n        margin-top: .15rem;\n}\n.topic .topic-reply .reply-list li .reply-content img {\n          max-width: 100%;\n          border: 0;\n          vertical-align: middle;\n}\n.topic .topic-reply .reply-list li:last-child {\n        border-bottom: none;\n}\n.topic .reply {\n    margin: 0 .15rem;\n}\n.topic .reply textarea {\n      width: 100%;\n      background-color: #fff;\n      font-size: .14rem;\n      padding: .15rem;\n      color: #313131;\n      border: 1px solid #d5dbdb;\n}\n.topic .reply .btn-reply {\n      border-bottom: 2px solid #3aa373;\n      background-color: #4fc08d;\n      font-size: .16rem;\n      margin: .15rem 0;\n      color: #fff;\n      padding: .1rem;\n      width: 100%;\n      border-radius: .03rem;\n}\n"],"sourceRoot":""}]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(53)("7952424c", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('nv-head', {
    ...
    return _c('li', [_c('router-link', {
      ...
      domProps: {
        "textContent": _vm._s(_vm.getTabInfo(item))
      }
    }), _vm._v(" "), _c('h3', {
      attrs: {
        "title": item.title
    ...
    }), _vm._v(" "), _c('span', [_vm._v(_vm._s(item.reply_count) + "/" + _vm._s(item.visit_count))])]), _vm._v(" "), _c('p', [_c('span', [_vm._v(_vm._s(_vm._f("timeAgo")(item.create_at)))]), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm._f("timeAgo")(item.last_reply_at)))])])])])])], 1)
  }))]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.showListLoad),
      expression: "showListLoad"
    }]
  }, [_vm._m(0)]), _vm._v(" "), _c('nv-top')], 1)
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "loading"
  }, [_c('i', {
...
//# sourceMappingURL=1.372b35d6cf17cfaeeb64.js.map