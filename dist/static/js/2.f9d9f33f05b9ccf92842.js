webpackJsonp([2],Array(60).concat([
/* 60 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_header__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_backtop__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_backtop___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_backtop__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_loading__ = __webpack_require__(123);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__store_mutationTypes__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_timeAgo__ = __webpack_require__(117);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_vuex__["b" /* mapState */])(['userInfo'])),
    methods: {
        getUserInfo() {
            this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_5__store_mutationTypes__["d" /* GET_USER_INFO */], this.$store.state.userInfo.loginname);
        }

    },
    filters: {
        timeAgo(str) {
            return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__utils_timeAgo__["a" /* timeAgo */])(str);
        },
        getCreateTime(str) {
            if (!str) {
                return '';
            }
            return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__utils_timeAgo__["a" /* timeAgo */])(str.split('T')[0]);
        }
    },

    components: {
        nvHead: __WEBPACK_IMPORTED_MODULE_1__components_header___default.a,
        nvTop: __WEBPACK_IMPORTED_MODULE_2__components_backtop___default.a,
...
// module
exports.push([module.i, ".user-home{padding-top:.4rem}.user-home .info{padding-top:.2rem;text-align:center;font-size:.3rem;padding-bottom:.2rem;border-bottom:1px solid #7aae74}.user-home .info .avatar{width:1rem;height:1rem;border-radius:50%;margin:0 auto}.user-home .info .name{padding-top:.1rem;color:#666}.user-home .info .bottom{padding-top:.1rem;font-size:.25rem}.user-home .info .bottom .time{padding-top:.1rem;color:#ababab}.user-home .info .bottom .score{color:#f6a5a5}", "", {"version":3,"sources":["D:/WorkSpace/vue2-cnode/src/pages/user.vue"],"names":[],"mappings":"AACA,WACE,iBAAmB,CACpB,AACD,iBACI,kBAAmB,AACnB,kBAAmB,AACnB,gBAAiB,AACjB,qBAAsB,AACtB,+BAAiC,CACpC,AACD,yBACM,WAAY,AACZ,YAAa,AACb,kBAAmB,AACnB,aAAe,CACpB,AACD,uBACM,kBAAmB,AACnB,UAAY,CACjB,AACD,yBACM,kBAAmB,AACnB,gBAAkB,CACvB,AACD,+BACQ,kBAAmB,AACnB,aAAe,CACtB,AACD,gCACQ,aAAe,CACtB","file":"user.vue","sourcesContent":["\n.user-home {\n  padding-top: .4rem;\n}\n.user-home .info {\n    padding-top: .2rem;\n    text-align: center;\n    font-size: .3rem;\n    padding-bottom: .2rem;\n    border-bottom: 1px solid #7aae74;\n}\n.user-home .info .avatar {\n      width: 1rem;\n      height: 1rem;\n      border-radius: 50%;\n      margin: 0 auto;\n}\n.user-home .info .name {\n      padding-top: .1rem;\n      color: #666;\n}\n.user-home .info .bottom {\n      padding-top: .1rem;\n      font-size: .25rem;\n}\n.user-home .info .bottom .time {\n        padding-top: .1rem;\n        color: #ababab;\n}\n.user-home .info .bottom .score {\n        color: #f6a5a5;\n}\n"],"sourceRoot":""}]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(53)("f356e3b4", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('nv-head', {
    ...
    staticClass: "score"
  }, [_vm._v("积分：" + _vm._s(_vm.userInfo.score))]), _vm._v(" "), _c('div', {
    staticClass: "time"
  }, [_vm._v("注册时间 " + _vm._s(_vm._f("getCreateTime")(_vm.userInfo.create_at)))])])])]), _vm._v(" "), _c('nv-top')], 1)
},staticRenderFns: []}

/***/ })
]));
//# sourceMappingURL=2.f9d9f33f05b9ccf92842.js.map