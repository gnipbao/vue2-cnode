webpackJsonp([4],Array(55).concat([
/* 55 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store_mutationTypes__ = __webpack_require__(18);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        handleLogin() {
            ...
            this.$store.dispatch(__WEBPACK_IMPORTED_MODULE_3__store_mutationTypes__["e" /* LOGIN */], data).then(() => {
...
// module
exports.push([module.i, ".login[data-v-2a60de14]{padding-top:.4rem}.login .login-token[data-v-2a60de14]{padding:0 .15rem;margin-top:.5rem}.login .login-token input[data-v-2a60de14]{padding:.12rem 0;border-bottom:1px solid #4fc08d;background-color:transparent;font-size:.14rem;color:#313131;width:100%}.login .login-token .btn-login[data-v-2a60de14]{width:100%;border-bottom:2px solid #3aa373;background-color:#4fc08d;font-size:.16rem;margin:.15rem 0;color:#fff;padding:.1rem;border-radius:.03rem}", "", {"version":3,"sources":["D:/WorkSpace/vue2-cnode/src/pages/login.vue"],"names":[],"mappings":"AACA,wBACE,iBAAmB,CACpB,AACD,qCACI,iBAAkB,AAClB,gBAAkB,CACrB,AACD,2CACM,iBAAkB,AAClB,gCAAiC,AACjC,6BAA8B,AAC9B,iBAAmB,AACnB,cAAe,AACf,UAAY,CACjB,AACD,gDACM,WAAY,AACZ,gCAAiC,AACjC,yBAA0B,AAC1B,iBAAkB,AAClB,gBAAiB,AACjB,WAAY,AACZ,cAAe,AACf,oBAAsB,CAC3B","file":"login.vue","sourcesContent":["\n.login[data-v-2a60de14] {\n  padding-top: .4rem;\n}\n.login .login-token[data-v-2a60de14] {\n    padding: 0 .15rem;\n    margin-top: .5rem;\n}\n.login .login-token input[data-v-2a60de14] {\n      padding: .12rem 0;\n      border-bottom: 1px solid #4fc08d;\n      background-color: transparent;\n      font-size: 0.14rem;\n      color: #313131;\n      width: 100%;\n}\n.login .login-token .btn-login[data-v-2a60de14] {\n      width: 100%;\n      border-bottom: 2px solid #3aa373;\n      background-color: #4fc08d;\n      font-size: .16rem;\n      margin: .15rem 0;\n      color: #fff;\n      padding: .1rem;\n      border-radius: .03rem;\n}\n"],"sourceRoot":""}]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(53)("42bf8c92", content, true);
...
//# sourceMappingURL=4.1c509ac3ee2ea5a6a7f4.js.map